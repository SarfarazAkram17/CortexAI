      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 z-50 h-screen w-75 sm:w-95 bg-[#0f1117] border border-white/10 shadow-2xl flex flex-col"
          >
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4">
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white cursor-pointer"
                >
                  Upgrade
                </button>
              </div>
              ...
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <p className="text-slate-400 text-sm mt-1">1500 Credits</p>
                <button
